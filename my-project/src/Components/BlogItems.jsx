...
const BlogItems = () => {
  const categories = ['Technology', 'Nature', 'Food', 'Travel', 'Art & Design'];
  const { blogRef } = useCart();

  return (
    <div ref={blogRef} className="flex justify-center items-center py-12 px-4">
      <div className="relative bg-[#f1f5f4] rounded-3xl shadow-xl w-full max-w-4xl p-6 md:p-10">
        ...
        <div className="relative z-10 text-center flex justify-center flex-col">
          <h1 className="text-3xl font-bold text-gray-800 mb-6">View Our Blogs</h1>
