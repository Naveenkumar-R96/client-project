    ...
    <div className="bg-white">
      ...
      <div className="bg-[#f9f9fb] relative py-16 text-center">
        ...
        <motion.h1
          ...
          className="text-4xl font-bold text-gray-800 z-10 relative"
        >
          Our Latest Insights
        </motion.h1>
        ...
        <motion.p
          ...
          className="text-sm text-gray-500 mt-2 z-10 relative font-medium"
        >
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {cards.map((card, index) => (
            ...
            >
              ...
              {/* Card content */}
              <div className="bshadow px-4 py-2">
                <div
                  style={{
                    position: "relative",
                    width: "100%",
              ...
              <div className="px-4 py-2 z-10 relative">
                <h2 className="font-bold text-lg text-gray-800 mt-1">{card.category}</h2>
                <p className={`${card.color} font-semibold text-sm`}>{card.title}</p>
              </div>
            </motion.div>
          ))}
        </div>
