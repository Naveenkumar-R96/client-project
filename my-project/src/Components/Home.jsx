    ...
    <div>
      <section className="bg-[#F4F6F8] mt-6 mx-4 md:mx-16 rounded-3xl py-16 px-4 md:px-10 relative h-[60vh] flex justify-center items-center">
        ...
        <div className="text-center max-w-7xl  mx-auto z-10 relative">
          <p className="text-sm text-blue-500 mt-3 z-10 relative font-semibold mb-2">Behind the Edit</p> 
          ...
          <p className="text-gray-600 text-base md:text-lg mb-8">
            Our Photoshop wizards turn average shots into breathtaking showcases. Every corner, every shadow, every color — perfected to drive attention and action.
